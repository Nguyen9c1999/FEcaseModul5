                ...
                {item.answers.map((answer, indexAnswer) => {
                    {
                        if (answer.status == 1) {
                            return <div className="form-outline mb-4">
                                <label style={{color: style, paddingLeft: "10px"}} className="form-label"
                                ...
                                <label>
                                    <Field style={{
                                        left: "25rem",
                                           ...
                                           name={indexQuestion.toString()} value={indexQuestion.toString()+indexAnswer.toString()+answer.status.toString()}/>
                                </label>
                            </div>
            ...
            <Formik initialValues={{}} onSubmit={(values) => {
                ...
                <Form>
                    ...
                    <div style={{marginTop: "30px", marginBottom: "40px"}}>
                        <button onClick={() => {
                            navigate('/home')
                        }} style={{marginRight: "-70px", marginLeft: "90px"}} class="btn btn-primary">Back
                        </button>
